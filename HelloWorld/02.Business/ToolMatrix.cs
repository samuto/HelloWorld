...
namespace WindowsFormsApplication7.Business
{
    class ToolMatrix
    {
        ...
        static ToolMatrix()
        {
            ...
            float good = 4f;
            float medium = 2f;
            RegisterEfficiency(ItemRepository.StoneShovel.Id,   BlockRepository.Dirt.Id,         good);
            RegisterEfficiency(ItemRepository.StoneShovel.Id,   BlockRepository.Grass.Id,        good);
